---
name: unslop
description: Cut AI tells from any writing and add a human voice. Apply to the full writing task whenever this skill is invoked.
disable-model-invocation: true
---

# Unslop

When invoked, apply this skill to the full writing task in scope. Preserve the meaning and intended tone.
